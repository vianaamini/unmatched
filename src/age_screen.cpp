...
AgeScreenResult AgeScreen::show()
{
    ...
    if (semiFont.texture.id != 0)
        SetTextureFilter(semiFont.texture, TEXTURE_FILTER_BILINEAR);
    ...
    while (!WindowShouldClose())
    {
        ...
        if (!submitted)
        {
            ...
            while (key > 0)
            {
                if (key >= '0' && key <= '9')
                {
                    ...
                    {
                        if (player1Age < 99)
                            player1Age = player1Age * 10 + key - '0';
                    ...
                    {
                        if (player2Age < 99)
                            player2Age = player2Age * 10 + key - '0';
        ...
        std::string age2 =
            (player2Age == 0)
                ? "Enter age"
                : std::to_string(player2Age);

        CenterText(
            normalFont,
            age2.c_str(),
            box2.x + box2.width / 2 - 10,
            box2.y + 17,
            19,
            0.5f,
            player2Age == 0
        ...
        CenterText(
            semiFont,
            "RETREAT",
            retreatButton.x + retreatButton.width / 2,
            retreatButton.y + 15,
            17,
            0.8f,
            retreatHover
        ...
        if (submitted)
        {
            ...
            {
                experience = "PLAYER II IS MORE EXPERIENCED";
            }
            else if (player2Age < player1Age)
            {
                experience = "PLAYER I IS MORE EXPERIENCED";
            }
            else
            {
                experience = "BOTH PLAYERS SHARE EQUAL EXPERIENCE";
            }
            ...
            DrawLine(
                (int)(resultBox.x + 30),
                (int)(resultBox.y + 75),
                (int)(resultBox.x + resultBox.width - 30),
                (int)(resultBox.y + 75),
                {110, 25, 32, 150}
            );
            ...
            if (player1Age < player2Age)
            {
                starter = "PLAYER I CHOOSES THEIR HERO FIRST";
            }
            else if (player2Age < player1Age)
            {
                starter = "PLAYER II CHOOSES THEIR HERO FIRST";
            }
            else
            {
                starter = "THE FOG WILL DECIDE WHO CHOOSES FIRST";
            }
            ...
            CenterText(
                ...
                advanceButton.x + advanceButton.width / 2,
                advanceButton.y + 12,
                12,
                0.4f,
                WHITE
            ...
            )
            {
                ...
                if (player1Age < player2Age)
                {
                    res = AgeScreenResult::Player1First;
                }
                else if (player2Age < player1Age)
                {
                    res = AgeScreenResult::Player2First;
                }
                else
                {
                    res = AgeScreenResult::EqualAge;
                }
